    ...
    <div>
      <nav className="navbar navbar-expand-lg bg-dark">
        <div className="container-fluid">
          <Link className="navbar-brand text-white" to="/"><h4>NEWS Portal</h4></Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link active text-white" aria-current="page" to="/buisness">Buisness</Link>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <Link className="nav-link active text-white" aria-current="page" to="/technologies">Technology</Link>
              </li>
            </ul>
          </div>
        </div>
